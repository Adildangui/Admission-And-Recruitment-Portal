...
class EduAttr(object):
        ...
        @property
        def EduAttrLabel(self):
                return self._EduAttrLabel

        @EduAttrLabel.setter
        def EduAttrLabel(self,eduAttrLabel):
                if (type(eduAttrLabel) is not str):
                        raise ValueError('EduAttrLabel must be type String')
                self._EduAttrLabel = str(eduAttrLabel)
